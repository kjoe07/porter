...
@IBDesignable open class RangeSeekSlider: UIControl {
    ...
    private func updateColors() {
        ...
        if let initialColor = initialColor?.cgColor, isInitial {
            ...
            let color1: CGColor = (leftHandleImage == nil) ? initialColor : UIColor.clear.cgColor
            leftHandle.backgroundColor = color1
            leftHandle.borderColor = color1
			let color2: CGColor = (rightHandleImage == nil) ? initialColor : UIColor.clear.cgColor
            rightHandle.backgroundColor = color2
            rightHandle.borderColor = color2
        } else {
